...
class GetEventTypeOutput20240614(BaseModel):
    """
    GetEventTypeOutput20240614
    """ # noqa: E501
    status: StrictStr
    data: Optional[EventTypeOutput20240614]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": EventTypeOutput20240614.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
