...
class GetSchedulesOutput20240611(BaseModel):
    """
    GetSchedulesOutput20240611
    """ # noqa: E501
    status: StrictStr
    data: List[ScheduleOutput20240611]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ScheduleOutput20240611.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "error": obj.get("error")
        })
        return _obj
