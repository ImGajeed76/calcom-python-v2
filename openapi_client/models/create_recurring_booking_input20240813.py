...
class CreateRecurringBookingInput20240813(BaseModel):
    """
    ...
    booking_fields_responses: Optional[Dict[str, Any]] = Field(default=None, description="Booking field responses.", alias="bookingFieldsResponses")
    __properties: ClassVar[List[str]] = ["start", "eventTypeId", "attendee", "guests", "location", "bookingFieldsResponses"]
