...
class ConnectedCalendar(BaseModel):
    ...
    credential_id: Union[StrictFloat, StrictInt] = Field(alias="credentialId")
    primary: Optional[Primary] = None
    calendars: Optional[List[Calendar]] = None
    __properties: ClassVar[List[str]] = ["integration", "credentialId", "primary", "calendars"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "primary": Primary.from_dict(obj["primary"]) if obj.get("primary") is not None else None,
            "calendars": [Calendar.from_dict(_item) for _item in obj["calendars"]] if obj.get("calendars") is not None else None
        })
        return _obj
