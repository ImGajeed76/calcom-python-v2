...
class GetScheduleOutput20240611(BaseModel):
    """
    GetScheduleOutput20240611
    """ # noqa: E501
    status: StrictStr
    data: Optional[ScheduleOutput20240611]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ScheduleOutput20240611.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error")
        })
        return _obj
