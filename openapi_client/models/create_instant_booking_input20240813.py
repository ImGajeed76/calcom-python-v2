...
class CreateInstantBookingInput20240813(BaseModel):
    """
    ...
    instant: StrictBool = Field(description="Flag indicating if the booking is an instant booking. Only available for team events.")
    __properties: ClassVar[List[str]] = ["start", "eventTypeId", "attendee", "guests", "meetingUrl", "location", "bookingFieldsResponses", "instant"]
