...
class DeleteCalendarCredentialsInputBodyDto(BaseModel):
    """
    DeleteCalendarCredentialsInputBodyDto
    """ # noqa: E501
    id: StrictInt = Field(description="Credential ID of the calendar to delete, as returned by the /calendars endpoint")
