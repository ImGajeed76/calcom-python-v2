...
class DeletedCalendarCredentialsOutputDto(BaseModel):
    """
    ...
    team_id: Optional[Union[StrictFloat, StrictInt]] = Field(alias="teamId")
    app_id: Optional[StrictStr] = Field(alias="appId")
    invalid: Optional[StrictBool]
