...
class ScheduleOutput20240611(BaseModel):
    """
    ...
    availability: List[ScheduleAvailabilityInput20240611]
    is_default: StrictBool = Field(alias="isDefault")
    overrides: List[ScheduleOverrideInput20240611]
    __properties: ClassVar[List[str]] = ["id", "ownerId", "name", "timeZone", "availability", "isDefault", "overrides"]
