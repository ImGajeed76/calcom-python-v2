...
class CancelBookingInput20240813(BaseModel):
    """
    CancelBookingInput20240813
    """ # noqa: E501
    cancellation_reason: StrictStr = Field(alias="cancellationReason")
    __properties: ClassVar[List[str]] = ["cancellationReason"]
