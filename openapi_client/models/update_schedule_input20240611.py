...
class UpdateScheduleInput20240611(BaseModel):
    """
    UpdateScheduleInput20240611
    """ # noqa: E501
    name: Optional[StrictStr] = None
    time_zone: Optional[StrictStr] = Field(default=None, alias="timeZone")
    availability: Optional[List[ScheduleAvailabilityInput20240611]] = None
    is_default: Optional[StrictBool] = Field(default=None, alias="isDefault")
    overrides: Optional[List[ScheduleOverrideInput20240611]] = None
