...
class UpdateTeamEventTypeInput20240614(BaseModel):
    """
    UpdateTeamEventTypeInput20240614
    """ # noqa: E501
    length_in_minutes: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="lengthInMinutes")
