...
class GetEventTypesOutput20240614(BaseModel):
    """
    GetEventTypesOutput20240614
    """ # noqa: E501
    status: StrictStr
    data: List[EventTypeOutput20240614]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [EventTypeOutput20240614.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
