...
class SlotsControllerGetAvailableSlots200Response(BaseModel):
    """
    SlotsControllerGetAvailableSlots200Response
    """ # noqa: E501
    status: Optional[StrictStr] = None
    data: Optional[SlotsControllerGetAvailableSlots200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": SlotsControllerGetAvailableSlots200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
