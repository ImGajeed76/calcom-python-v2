...
class OrgMeTeamsOutputResponseDto(BaseModel):
    """
    OrgMeTeamsOutputResponseDto
    """ # noqa: E501
    status: StrictStr
    data: List[OrgTeamOutputDto]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [OrgTeamOutputDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
