...
class OAuthClientWebhooksOutputResponseDto(BaseModel):
    """
    OAuthClientWebhooksOutputResponseDto
    """ # noqa: E501
    status: StrictStr
    data: List[OAuthClientWebhookOutputDto]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [OAuthClientWebhookOutputDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
