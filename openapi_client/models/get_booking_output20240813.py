...
class GetBookingOutput20240813(BaseModel):
    """
    GetBookingOutput20240813
    """ # noqa: E501
    status: StrictStr
    data: GetBookingOutput20240813Data
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GetBookingOutput20240813Data.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error")
        })
        return _obj
