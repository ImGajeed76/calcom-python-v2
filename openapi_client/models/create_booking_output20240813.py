...
class CreateBookingOutput20240813(BaseModel):
    """
    CreateBookingOutput20240813
    """ # noqa: E501
    status: StrictStr
    data: CreateBookingOutput20240813Data
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CreateBookingOutput20240813Data.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
