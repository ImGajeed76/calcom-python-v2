...
class SlotsControllerReserveSlot201Response(BaseModel):
    """
    SlotsControllerReserveSlot201Response
    """ # noqa: E501
    status: Optional[StrictStr] = None
    data: Optional[SlotsControllerReserveSlot201ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": SlotsControllerReserveSlot201ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
