...
class UserWebhooksOutputResponseDto(BaseModel):
    """
    UserWebhooksOutputResponseDto
    """ # noqa: E501
    status: StrictStr
    data: List[UserWebhookOutputDto]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [UserWebhookOutputDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
