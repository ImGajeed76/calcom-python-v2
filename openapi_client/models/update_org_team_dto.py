...
class UpdateOrgTeamDto(BaseModel):
    """
    UpdateOrgTeamDto
    """ # noqa: E501
    ...
    booking_limits: Optional[StrictStr] = Field(default=None, alias="bookingLimits")
    include_managed_events_in_limits: Optional[StrictBool] = Field(default=None, alias="includeManagedEventsInLimits")
    __properties: ClassVar[List[str]] = ["name", "slug", "logoUrl", "calVideoLogo", "appLogo", "appIconLogo", "bio", "hideBranding", "isPrivate", "hideBookATeamMember", "metadata", "theme", "brandColor", "darkBrandColor", "bannerUrl", "timeFormat", "timeZone", "weekStart", "bookingLimits", "includeManagedEventsInLimits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bookingLimits": obj.get("bookingLimits"),
            "includeManagedEventsInLimits": obj.get("includeManagedEventsInLimits")
        })
        return _obj
