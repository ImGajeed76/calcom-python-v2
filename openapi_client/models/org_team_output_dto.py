...
class OrgTeamOutputDto(BaseModel):
    """
    OrgTeamOutputDto
    """ # noqa: E501
    id: Union[StrictFloat, StrictInt]
    parent_id: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="parentId")
    ...
    hide_branding: Optional[StrictBool] = Field(default=None, alias="hideBranding")
    ...
    hide_book_a_team_member: Optional[StrictBool] = Field(default=False, alias="hideBookATeamMember")
    ...
    __properties: ClassVar[List[str]] = ["id", "parentId", "name", "slug", "logoUrl", "calVideoLogo", "appLogo", "appIconLogo", "bio", "hideBranding", "isOrganization", "isPrivate", "hideBookATeamMember", "metadata", "theme", "brandColor", "darkBrandColor", "bannerUrl", "timeFormat", "timeZone", "weekStart"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hideBookATeamMember": obj.get("hideBookATeamMember") if obj.get("hideBookATeamMember") is not None else False,
