...
class OrgTeamMembershipsOutputResponseDto(BaseModel):
    """
    OrgTeamMembershipsOutputResponseDto
    """ # noqa: E501
    status: StrictStr
    data: List[OrgTeamMembershipOutputDto]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [OrgTeamMembershipOutputDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
