...
class TeamWebhooksOutputResponseDto(BaseModel):
    """
    TeamWebhooksOutputResponseDto
    """ # noqa: E501
    status: StrictStr
    data: List[TeamWebhookOutputDto]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [TeamWebhookOutputDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
