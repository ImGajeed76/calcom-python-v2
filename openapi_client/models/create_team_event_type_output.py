...
class CreateTeamEventTypeOutput(BaseModel):
    """
    CreateTeamEventTypeOutput
    """ # noqa: E501
    status: StrictStr
    data: CreateTeamEventTypeOutputData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CreateTeamEventTypeOutputData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
