...
class Primary(BaseModel):
    ...
    primary: Optional[StrictBool]
    read_only: StrictBool = Field(alias="readOnly")
    email: Optional[StrictStr] = None
    is_selected: StrictBool = Field(alias="isSelected")
    credential_id: Union[StrictFloat, StrictInt] = Field(alias="credentialId")
    __properties: ClassVar[List[str]] = ["externalId", "integration", "name", "primary", "readOnly", "email", "isSelected", "credentialId"]
