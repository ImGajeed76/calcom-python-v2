...
class AssignOrganizationAttributeOptionToUserInput(BaseModel):
    """
    AssignOrganizationAttributeOptionToUserInput
    """ # noqa: E501
    value: Optional[StrictStr] = None
    attribute_option_id: Optional[StrictStr] = Field(default=None, alias="attributeOptionId")
    attribute_id: StrictStr = Field(alias="attributeId")
    __properties: ClassVar[List[str]] = ["value", "attributeOptionId", "attributeId"]
