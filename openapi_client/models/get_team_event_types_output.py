...
class GetTeamEventTypesOutput(BaseModel):
    """
    GetTeamEventTypesOutput
    """ # noqa: E501
    status: StrictStr
    data: List[TeamEventTypeOutput20240614]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [TeamEventTypeOutput20240614.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
