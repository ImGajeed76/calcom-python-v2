...
class TestConnectedCalendar(unittest.TestCase):
    """ConnectedCalendar unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectedCalendar:
        """Test ConnectedCalendar
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectedCalendar`
        """
    ...
    def testConnectedCalendar(self):
        """Test ConnectedCalendar"""
