...
class TestUpdateWebhookInputDto(unittest.TestCase):
    """UpdateWebhookInputDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateWebhookInputDto:
        """Test UpdateWebhookInputDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateWebhookInputDto`
        """
        model = UpdateWebhookInputDto()
        if include_optional:
            return UpdateWebhookInputDto(
    ...
    def testUpdateWebhookInputDto(self):
        """Test UpdateWebhookInputDto"""
