...
class TestGetTeamEventTypeOutput(unittest.TestCase):
    """GetTeamEventTypeOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTeamEventTypeOutput:
        """Test GetTeamEventTypeOutput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTeamEventTypeOutput`
        """
        model = GetTeamEventTypeOutput()
        if include_optional:
            return GetTeamEventTypeOutput(
                status = 'success',
                data = openapi_client.models.team_event_type_output_2024_06_14.TeamEventTypeOutput_2024_06_14(
                    id = 1, 
    ...
    def testGetTeamEventTypeOutput(self):
        """Test GetTeamEventTypeOutput"""
