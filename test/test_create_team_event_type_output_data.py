...
class TestCreateTeamEventTypeOutputData(unittest.TestCase):
    """CreateTeamEventTypeOutputData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateTeamEventTypeOutputData:
        """Test CreateTeamEventTypeOutputData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateTeamEventTypeOutputData`
        """
        model = CreateTeamEventTypeOutputData()
        if include_optional:
            return CreateTeamEventTypeOutputData(
                id = 1,
    ...
    def testCreateTeamEventTypeOutputData(self):
        """Test CreateTeamEventTypeOutputData"""
