...
class TestConnectedCalendarsData(unittest.TestCase):
    """ConnectedCalendarsData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectedCalendarsData:
        """Test ConnectedCalendarsData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectedCalendarsData`
        """
        model = ConnectedCalendarsData()
        if include_optional:
            return ConnectedCalendarsData(
                connected_calendars = [
    ...
    def testConnectedCalendarsData(self):
        """Test ConnectedCalendarsData"""
